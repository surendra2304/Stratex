...
def run_phase7_pipeline():
    print("==============================================")
    print("PHASE 7: RESEARCH PIPELINE INITIALIZING")
    print("==============================================\n")
    
    os.makedirs('backtest_results/phase7', exist_ok=True)
    experiment_log = []
    ...
    # 2. Build Features
    print("[PHASE 7] Engineering Institutional Features (CVD, FracDiff, Microstructure)...")
    df = build_institutional_features(df, use_frac_diff=True, d=0.3)
    
    # 3. Triple Barrier Labels
    print("[PHASE 7] Applying Triple-Barrier Labels (PT=0.3%, SL=0.15%, T=15)...")
    ...
    with open('backtest_results/phase7/feature_ablation.md', 'w') as f:
        f.write("# Phase 7: Feature Ablation Results\n\n")
    ...
    with open('backtest_results/phase7/cost_threshold_analysis.md', 'w') as f:
        f.write("# Phase 7: Cost Threshold Analysis\n\n")
    ...
    with open('backtest_results/phase7/PHASE7_SUMMARY.md', 'w') as f:
        f.write("# PHASE 7 EXECUTIVE SUMMARY\n\n")
    ...
    with open('backtest_results/phase7/experiment_log.json', 'w') as f:
        json.dump(experiment_log, f, indent=4)
        
    print("\nPhase 7 research pipeline execution complete!")
    print("Reports generated in `backtest_results/phase7/`")
