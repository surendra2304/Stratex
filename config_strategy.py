...
PRODUCTION_STRATEGY_REGISTRY = {
    ...
    "bb_reversion": {
        ...
        "trading_mode": "FUTURES",
        "execution_model": "RULE_BASED",
        "entry_conditions": "Price pierces Bollinger Band (20, 2) and closes back inside. Long on lower pierce, Short on upper pierce.",
        "sl_method": "0.5 * ATR(14)",
        ...
        "reason": "Bollinger Band Mean Reversion scalper across 1m, 5m, 15m, 30m, 1h, 4h.",
    },
    "rsi_burst": {
        "status": "VALIDATED",
        "version": "V1-futures-multi-tf (2026-08-24)",
        ...
        "trading_mode": "FUTURES",
        "execution_model": "RULE_BASED",
        "entry_conditions": "RSI(14) crosses back above 30 from oversold (Long) or below 70 from overbought (Short).",
        "sl_method": "0.5 * ATR(14)",
        "tp_method": "1.5 * ATR(14)",
        "rr_ratio": 3.0,
        "oos_win_rate_prior": 0.500,
        ...
        "reason": "RSI Momentum Burst scalper across 1m, 5m, 15m, 30m, 1h, 4h.",
    },
    "vwap_trend": {
        "status": "VALIDATED",
        "version": "V1-futures-multi-tf (2026-08-24)",
        ...
        "trading_mode": "FUTURES",
        "execution_model": "RULE_BASED",
        "entry_conditions": "Price crosses VWAP in alignment with EMA(9)/EMA(21) trend.",
        "sl_method": "0.5 * ATR(14)",
        "tp_method": "1.5 * ATR(14)",
        "rr_ratio": 3.0,
        "oos_win_rate_prior": 0.500,
        ...
        "reason": "VWAP Trend Follow scalper across 1m, 5m, 15m, 30m, 1h, 4h.",
    },
    "aggressor": {
        "status": "DISABLED",
        "timeframe": "1m",
