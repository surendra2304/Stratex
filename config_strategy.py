...
PRODUCTION_STRATEGY_REGISTRY = {
    ...
    "aggressive_scalper": {
        ...
        "trading_mode": "FUTURES",
        "execution_model": "RULE_BASED",
        "reason": "Disabled in favor of Strategy Factory Top 5 Winners.",
    },
    "bb_reversion": {
        "status": "DISABLED",
        "version": "V1-futures-multi-tf (2026-08-24)",
    ...
    "factory_winner_2": {
        ...
        "trading_mode": "FUTURES",
        "execution_model": "RULE_BASED",
        "entry_conditions": "5m MACD(12,26,9) crossover with Bollinger Bands(20,2) mean-dip confluence. SL: 1.0x ATR, TP: 2.0x ATR.",
        "sl_method": "1.0 * ATR(14)",
        "tp_method": "2.0 * ATR(14)",
        "rr_ratio": 2.0,
    ...
    "factory_winner_3": {
        ...
        "trading_mode": "FUTURES",
        "execution_model": "RULE_BASED",
        "entry_conditions": "5m MACD(12,26,9) crossover with Bollinger Bands(20,2) mean-dip confluence. SL: 0.5x ATR, TP: 1.5x ATR.",
    ...
    "factory_winner_5": {
        ...
        "trading_mode": "FUTURES",
        "execution_model": "RULE_BASED",
        "entry_conditions": "15m MACD(12,26,9) crossover with Bollinger Bands(20,2) mean-dip confluence. SL: 0.5x ATR, TP: 1.5x ATR.",
        "sl_method": "0.5 * ATR(14)",
        "tp_method": "1.5 * ATR(14)",
        "rr_ratio": 3.0,
