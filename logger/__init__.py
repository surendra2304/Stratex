"""
logger/__init__.py — Unified Logger Package.
Provides get_logger(), trade logging, and structured JSON logging.
Decoupled from config.py to avoid startup credential validation deadlocks.
"""
...
class JSONFormatter(logging.Formatter):
    def format(self, record):
        mode = os.getenv("TRADING_MODE", TRADING_MODE)
        log_record = {
