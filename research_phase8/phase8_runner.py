...
def write_reports(results):
    os.makedirs('backtest_results/stage8', exist_ok=True)
    
    # 1. timeframe_comparison.md & 1M VS 15M VS 1H DIRECT COMPARISON
    with open('backtest_results/stage8/timeframe_comparison.md', 'w') as f:
        f.write("# Stage 8: Multi-Timeframe Direct Comparison\n\n")
    ...
    with open('backtest_results/stage8/volatility_cost_analysis.md', 'w') as f:
        f.write("# Stage 8: Volatility vs Cost Analysis\n\n")
    ...
    # 3. Final Summary
    with open('backtest_results/stage8/stage8_summary.md', 'w') as f:
        f.write("# Stage 8 FINAL SUMMARY\n\n")
        ...
        if viable_tfs:
            ...
            f.write("Proceeding to Stage 9 Paper Trading architecture is AUTHORIZED.\n")
        else:
...
def run_stage8_pipeline():
    print("==============================================")
    print("Stage 8: MULTI-TIMEFRAME ECONOMIC EVALUATION")
    print("==============================================\n")
    
    print("[Stage 8] Loading BTCUSDT base 1-minute dataset...")
    df_1m = download_and_verify_data(symbol="BTCUSDT", days=90, use_cache=True)
    
    print("[Stage 8] Launching massive multi-timeframe grid search...")
    results = run_multi_timeframe_grid(df_1m)
    
    print("[Stage 8] Generating 15 required markdown reports...")
    write_reports(results)
    
    with open('backtest_results/stage8/experiment_log.json', 'w') as f:
        json.dump(results, f, indent=4)
        
    print("\n[Stage 8] Complete! Reports written to backtest_results/stage8/")
